/**
 * lwipopts.h — lwIP configuration for healthbar firmware
 *
 * Based on pico-examples/pico_w/wifi/lwipopts_examples_common.h, trimmed for
 * AP-only portal use (M0/M1). No TLS, no httpd library — we hand-roll HTTP.
 *
...
/* Debug: off in release, selectively enabled in debug builds */
#ifndef NDEBUG
#define LWIP_DEBUG                  1
#define LWIP_STATS                  1

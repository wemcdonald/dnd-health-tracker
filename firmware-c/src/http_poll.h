 ...
 *
 * Polls the server's precomputed file and parses line 1 ("<lit> <age>").
 * No TLS. Uses the lwIP raw TCP API under cyw43_arch threadsafe_background.
 */
 ...
 * body line 1 parses as two ints, returns true and sets *lit and *age_s.
 * Any failure (connect/timeout/non-200/parse) returns false. */
